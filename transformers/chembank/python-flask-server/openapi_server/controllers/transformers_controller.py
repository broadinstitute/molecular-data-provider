...
from openapi_server.controllers.chembank_transformer import ChemBankProducer

transformer = {'compounds':ChemBankProducer()}
...
def service_transform_post(service, body):  # noqa: E501
    ...
    :rtype: List[OneOfgeneInfocompoundInfo]
    """
