...
from openapi_server.controllers.pharmgkb_transformer import PharmgkbCompoundProducer
from openapi_server.controllers.pharmgkb_transformer import PharmgkbRelationsTransformer
from openapi_server.controllers.pharmgkb_transformer import PharmgkbTextMineTransformer

transformer = {'chemicals': PharmgkbCompoundProducer(),
               'relations': PharmgkbRelationsTransformer(),
               'text-mining':PharmgkbTextMineTransformer()}
