...
from openapi_server.controllers.drugbank_transformer import DrugBankProducer, DrugBankTargetTransformer, DrugBankInhibitorsTransformer

transformer = {'drugs':DrugBankProducer(), 'targets':DrugBankTargetTransformer(), 'inhibitors':DrugBankInhibitorsTransformer()}
