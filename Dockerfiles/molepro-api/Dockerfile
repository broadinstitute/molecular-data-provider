...
COPY --from=packaging-image /usr/src/base/target/universal/molecular-data-provider-2.4.3.tgz /usr/src/target
RUN gunzip molecular-data-provider-2.4.3.tgz
RUN tar xf molecular-data-provider-2.4.3.tar
WORKDIR /usr/src/target/molecular-data-provider-2.4.3
EXPOSE 9200
