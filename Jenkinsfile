pipeline {
    ...
    stages {
        ...
        stage('build') {
            ...
            steps {
                withEnv([
                    "IMAGE_NAME=translator-molepro-rephub",
        ...
        stage('Deploy') {
            ...
            steps {
                sshagent (credentials: ['labshare-svc']) {
                    dir(".") {
                        sh 'git clone -b rephub-ci-update git@github.com:Sphinx-Automation/translator-ops.git'
                        configFileProvider([
                        ...
                        withAWS(credentials:'aws-ifx-deploy') {
                            ...
                            cp -R translator-ops/ops/molepro/config/transformers/molepro-rephub.yaml translator-ops/ops/molepro/helm/
