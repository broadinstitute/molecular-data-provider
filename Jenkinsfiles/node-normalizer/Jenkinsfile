pipeline {
    ...
    stages {
        ...
        stage('build') {
            ...
            steps {
                withEnv([
                    "IMAGE_NAME=853771734544.dkr.ecr.us-east-1.amazonaws.com/translator-molepro-node-normalizer",
            ...
            steps {
                configFileProvider([
                    ...
                    script {
                        ...
                        /bin/bash prepare.sh
                        cp translator-ops/ops/molepro/config/transformers/molepro-node-normalizer.yaml translator-ops/ops/molepro/helm/
