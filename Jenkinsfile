        ...
        stage('Deploy') {
            ...
            steps {
                sshagent (credentials: ['labshare-svc']) {
                    dir(".") {
                        sh 'git clone -b sider git@github.com:Sphinx-Automation/translator-ops.git'
                        configFileProvider([
                        ...
                        withAWS(credentials:'aws-ifx-deploy') {
                            ...
                            cp -R translator-ops/ops/molepro/config/transformers/molepro-sider.yaml translator-ops/ops/molepro/helm/
