...
from openapi_server.controllers.chembl_transformer import ChemblProducer, ChemblTargetTransformer

transformer = {'molecules':ChemblProducer(), 'targets': ChemblTargetTransformer()}
