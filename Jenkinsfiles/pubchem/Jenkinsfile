pipeline {
    ...
    stages {
        ...
        stage('build') {
            ...
            steps {
                withEnv([
                    "IMAGE_NAME=853771734544.dkr.ecr.us-east-1.amazonaws.com/translator-molepro-pubchem",
                    ...
                    script {
                        ...
                        docker tag alpine:latest 853771734544.dkr.ecr.us-east-1.amazonaws.com/translator-molepro-pubchem:alpine-latest
                        docker push 853771734544.dkr.ecr.us-east-1.amazonaws.com/translator-molepro-pubchem:alpine-latest 
                        '''
                    }
                }
            }
            ...
            steps {
                configFileProvider([
                    ...
                    script {
                        ...
                        cp translator-ops/ops/moleprowithdb/config/transformers/molepro-pubchem.yaml translator-ops/ops/moleprowithdb/helm/
