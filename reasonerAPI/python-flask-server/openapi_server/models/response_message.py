...
class ResponseMessage(Model):
    ...
    def __init__(self, results=None, query_graph=None, knowledge_graph=None, auxiliary_graphs=None):  # noqa: E501
        ...
        :param results: The results of this ResponseMessage.  # noqa: E501
        :type results: List[Result]
        :param query_graph: The query_graph of this ResponseMessage.  # noqa: E501
        :type query_graph: MessageQueryGraph
        :param knowledge_graph: The knowledge_graph of this ResponseMessage.  # noqa: E501
        :type knowledge_graph: MessageKnowledgeGraph
        :param auxiliary_graphs: The auxiliary_graphs of this ResponseMessage.  # noqa: E501
    ...
    def from_dict(cls, dikt) -> 'ResponseMessage':
        ...
        :param dikt: A dict.
        :type: dict
        :return: The Response_message of this ResponseMessage.  # noqa: E501
    ...
    @property
    def results(self):
        """Gets the results of this ResponseMessage.
        ...
        :return: The results of this ResponseMessage.
        :rtype: List[Result]
        """
    ...
    def results(self, results):
        """Sets the results of this ResponseMessage.

        List of all returned Result objects for the query posed. The list SHOULD NOT be assumed to be ordered. The 'score' property, if present, MAY be used to infer result rankings. If Results are not expected (such as for a query Message), this property SHOULD be null or absent. If Results are expected (such as for a response Message) and no Results are available, this property SHOULD be an array with 0 Results in it.  # noqa: E501

        :param results: The results of this ResponseMessage.
        :type results: List[Result]
        """
    ...
    def query_graph(self):
        """Gets the query_graph of this ResponseMessage.


        :return: The query_graph of this ResponseMessage.
    ...
    def query_graph(self, query_graph):
        """Sets the query_graph of this ResponseMessage.


        :param query_graph: The query_graph of this ResponseMessage.
        :type query_graph: MessageQueryGraph
        """
    ...
    def knowledge_graph(self):
        """Gets the knowledge_graph of this ResponseMessage.


        :return: The knowledge_graph of this ResponseMessage.
    ...
    def knowledge_graph(self, knowledge_graph):
        """Sets the knowledge_graph of this ResponseMessage.


        :param knowledge_graph: The knowledge_graph of this ResponseMessage.
        :type knowledge_graph: MessageKnowledgeGraph
        """
    ...
    def auxiliary_graphs(self):
        """Gets the auxiliary_graphs of this ResponseMessage.
        ...
        :return: The auxiliary_graphs of this ResponseMessage.
    ...
    def auxiliary_graphs(self, auxiliary_graphs):
        """Sets the auxiliary_graphs of this ResponseMessage.

        Dictionary of AuxiliaryGraph instances that are used by Knowledge Graph Edges and Result Analyses. These are referenced elsewhere by the dictionary key.  # noqa: E501

        :param auxiliary_graphs: The auxiliary_graphs of this ResponseMessage.
        :type auxiliary_graphs: Dict[str, AuxiliaryGraph]
        """
