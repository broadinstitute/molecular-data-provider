## How to deploy String transformer

### Package transformer

Package transformer itself
```
cd transformers/string/python-flask-server
...
copy `transformers/string/python-flask-server/dist/string_transformer-2.3.0-py3-none-any.whl` to the target folder

copy `util/python/transformers-2.0/dist/base_transformer-2.0.0-py3-none-any.whl` to the target folder

copy `transformers/string/python-flask-server/info` folder to the target folder
...
pip install -I string_transformer-2.3.0-py3-none-any.whl
