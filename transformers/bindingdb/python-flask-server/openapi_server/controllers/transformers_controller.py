...
from openapi_server.controllers.bindingdb_transformer import BindingDbLigandProducer, BindingDbTransformer

transformer = {
    'ligands' : BindingDbLigandProducer(), 
    'bindings' : BindingDbTransformer()
}
