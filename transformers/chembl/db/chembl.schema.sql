--
-- File generated with SQLiteStudio v3.2.1 on Thu Feb 1 15:19:34 2024
--
...
CREATE TABLE activities (
	...
	CONSTRAINT fk_act_action_type FOREIGN KEY(action_type) REFERENCES action_type (action_type) ON DELETE CASCADE, 
...
CREATE TABLE activity_properties (
	...
	standard_value NUMERIC, 
	standard_units VARCHAR(100), 
	standard_text_value VARCHAR(2000), 
...
CREATE TABLE chembl_release (
	chembl_release_id INTEGER NOT NULL, 
	chembl_release VARCHAR(20), 
	creation_date DATETIME, 
	CONSTRAINT pk_chembl_release PRIMARY KEY (chembl_release_id)
);
...
CREATE TABLE data_validity_lookup (
	...
	description VARCHAR(200), 
	CONSTRAINT sys_c00153496 PRIMARY KEY (data_validity_comment)
);
...
CREATE TABLE docs (
	...
	CONSTRAINT fk_docs_chembl_release_id FOREIGN KEY(chembl_release_id) REFERENCES chembl_release (chembl_release_id) ON DELETE CASCADE, 
...
CREATE TABLE drug_warning (
	...
	efo_term VARCHAR(200), 
	efo_id VARCHAR(20), 
	efo_id_for_warning_class VARCHAR(20), 
	CONSTRAINT sys_c00153461 PRIMARY KEY (warning_id), 
