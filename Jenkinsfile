pipeline {
    ...
    stages {
        ...
        stage('build') {
            ...
            steps {
                withEnv([
                    "IMAGE_NAME=translator-molepro-pharos",
        ...
        stage('Deploy') {
            ...
            steps {
                sshagent (credentials: ['labshare-svc']) {
                    dir(".") {
                        sh 'git clone -b phaors-update git@github.com:Sphinx-Automation/translator-ops.git'
                        configFileProvider([
                        ...
                        withAWS(credentials:'aws-ifx-deploy') {
                            ...
                            cp -R translator-ops/ops/molepro/config/transformers/molepro-pharos.yaml translator-ops/ops/molepro/helm/
