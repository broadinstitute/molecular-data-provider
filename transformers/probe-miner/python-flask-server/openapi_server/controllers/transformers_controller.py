...
from openapi_server.controllers.probeminer_transformer import ProbeMinerCompoundProducer
from openapi_server.controllers.probeminer_transformer import ProbeMinerChemicalInteractionsTransformer
from openapi_server.controllers.probeminer_transformer import ProbeMinerProteinInteractionsTransformer

transformer = {
    'chemicals': ProbeMinerCompoundProducer(),
    'chemical_interactions': ProbeMinerChemicalInteractionsTransformer(),
    'protein_interactions': ProbeMinerProteinInteractionsTransformer()
}
