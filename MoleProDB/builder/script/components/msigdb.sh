...
sbt 'run data/msigdb/MolePro.MSigDB.sqlite load-prefixes'
...
sbt -mem 16384 'run data/msigdb/MolePro.MSigDB.sqlite load-connections entrez data/msigdb/MSigDB-gene-id.tsv "MSigDB pathways transformer" msigdb'
