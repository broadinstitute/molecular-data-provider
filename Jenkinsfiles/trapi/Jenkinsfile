pipeline {
    ...
    stages {
        ...
        stage('build') {
            ...
            steps {
                withEnv([
                    "IMAGE_NAME=853771734544.dkr.ecr.us-east-1.amazonaws.com/translator-molepro-trapi",
            ...
            steps {
                configFileProvider([
                    ...
                    script {
                        ...
                        /bin/bash prepare-reasonerapi.sh
                        cd translator-ops/ops/molepro/reasonerapi/
                        /bin/bash deploy.sh
                        '''
                    } 
                }    
