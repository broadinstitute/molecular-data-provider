...
COPY transformers/molepro-db/python-flask-server/conf /usr/src/app/conf
...
ADD https://translator.broadinstitute.org/db/MoleProDB.sqlite /usr/src/app/database
...
RUN pip3 install -I moleprodb_transformer-2.5.0-py3-none-any.whl
