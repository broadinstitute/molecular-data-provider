            ...
            steps {
                withEnv([
                    ...
                    script {
                        ...
                        docker tag alpine:latest 853771734544.dkr.ecr.us-east-1.amazonaws.com/translator-molepro-stitch:alpine-latest
                        docker push 853771734544.dkr.ecr.us-east-1.amazonaws.com/translator-molepro-stitch:alpine-latest 
                        '''
                    }
                }
            }
